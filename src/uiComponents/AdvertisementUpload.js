        ...
        if (file) {
            ...
            img.onload = function(){
                ...
                if(this.width !== 250 || this.height !== 250){
                    alert('O arquivo selecionado tem ' + this.width + ' X ' + this.height + ' pixels, mas o formato aceito é apenas 250 X 250 pixels.');
                    return;
                }
        ...
        <UploadArea value={value}>
            {value !== '' ?
                ...
                <>
                    ...
                    <SpanDetail>
                        Somente JPG, GIF e PNG - Tamanho 250 x 250 - Até 200 Kb
                    </SpanDetail>
                    <SpanIcon>
