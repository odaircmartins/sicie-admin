        ...
        api.delete('/events/' + oldData._id)
            .then(response => {
                if (response.status === 200) {
                    ...
                    setMessageSuccess('Evento excluído com sucesso');
                    setLoading(false);
                    handleShowAlertSuccess();
                    //console.log(response.data);
                }
        ...
        <>
            <MaterialTable
                ...
                actions={[
                    ...
                    //     tooltip: 'Add User',
                    //     isFreeAction: true,
                    //     onClick: (event) => history.push('/criar-evento')
                    // },
                    {
                        icon: 'library_add',
                        tooltip: 'Copiar',
