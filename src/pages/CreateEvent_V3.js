...
const Event = () => {
    ...
    const formModel = {
        ...
        eventTicketType1: '',
        eventTicketPrice1: '',
        eventTicketIsVip1: false,
        eventTicketType2: '',
        eventTicketPrice2: '',
        eventTicketIsVip2: false,
        eventTicketType3: '',
        eventTicketPrice3: '',
        eventTicketIsVip3: false,
        eventTicketType4: '',
        eventTicketPrice4: '',
        eventTicketIsVip4: false,
        eventTicketType5: '',
        eventTicketPrice5: '',
        eventTicketIsVip5: false,
        group: ''
    }
    ...
    const handleVip1IsActive = (e) => {
        setFormValues({ ...formValues, 'eventTicketIsVip1': e.target.checked });
    };

    const handleVip2IsActive = (e) => {
        setFormValues({ ...formValues, 'eventTicketIsVip2': e.target.checked });
    };

    const handleVip3IsActive = (e) => {
        setFormValues({ ...formValues, 'eventTicketIsVip3': e.target.checked });
    };

    const handleVip4IsActive = (e) => {
        setFormValues({ ...formValues, 'eventTicketIsVip4': e.target.checked });
    };

    const handleVip5IsActive = (e) => {
        setFormValues({ ...formValues, 'eventTicketIsVip5': e.target.checked });
    };
                ...
                <ContainerStyled>
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={2} alignItems="center" direction="row">
                            ...
                            <Grid item xs={2}>
                                <SwitchMuiStyled name="isActive" label="Liberar VIP" checked={formValues.eventTicketIsVip1} onChange={handleVip1IsActive || false} />
                            </Grid>
                            ...
                            <Grid item xs={2}>
                                <SwitchMuiStyled name="isActive" label="Liberar VIP" checked={formValues.eventTicketIsVip2} onChange={handleVip2IsActive || false} />
                            </Grid>
                            ...
                            <Grid item xs={2}>
                                <SwitchMuiStyled name="isActive" label="Liberar VIP" checked={formValues.eventTicketIsVip3} onChange={handleVip3IsActive || false} />
                            </Grid>
                            ...
                            <Grid item xs={2}>
                                <SwitchMuiStyled name="isActive" label="Liberar VIP" checked={formValues.eventTicketIsVip4} onChange={handleVip4IsActive || false} />
                            </Grid>
                            ...
                            <Grid item xs={2}>
                                <SwitchMuiStyled name="isActive" label="Liberar VIP" checked={formValues.eventTicketIsVip5} onChange={handleVip5IsActive || false} />
                            </Grid>
